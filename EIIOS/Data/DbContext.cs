...
namespace EIIOS.Data
{
    ...
    new ProductIngredientModel { Id = 20, ProductId = 4, InventoryItemId = 13, QuantityNeeded = 0.05m, Unit = "kg" },
    new ProductIngredientModel { Id = 21, ProductId = 4, InventoryItemId = 17, QuantityNeeded = 0.02m, Unit = "l" },
